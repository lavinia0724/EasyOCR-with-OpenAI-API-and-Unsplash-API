# LAVI's EasyOCR with OpenAI API Side Project
利用 [Unsplash API download dataset](https://unsplash.com/)、透過 [OpenAI API model image to image](https://platform.openai.com/docs/api-reference/images)、使用 easyOCR text detection
